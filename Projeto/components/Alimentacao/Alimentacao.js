    ...
    <View style={estilos.container}>
      ...
      >
        ...
        {mostrarDieta === 'Emagrecer' && renderizarDieta('Dieta para Emagrecer', 
          `Café da Manhã:
          1 porção de aveia cozida com frutas frescas (como morangos ou banana) e uma colher de chá de mel.
          1 xícara de leite desnatado ou alternativa de leite não lácteo.
          ...
          Almoço:
          150g de peito de frango grelhado ou assado.
          1 porção de quinoa ou arroz integral.
          Vegetais variados, como brócolis, cenoura e couve.
          Salada verde com folhas variadas e um molho à base de azeite de oliva.

          Lanche da Tarde:
          Iogurte grego natural sem açúcar.
          Um punhado de berries (morangos, mirtilos).

          Jantar:
          150g de salmão grelhado.
          Batata-doce assada.
          Aspargos ou outro vegetal de sua preferência.

          Ceia (opcional):
          Um copo de leite desnatado ou uma alternativa de leite não lácteo.`)}
        ...
        {mostrarDieta === 'Equilibrada' && renderizarDieta('Dieta Equilibrada', 
          ...
          Vegetais cozidos, como cenoura e brócolis.
          Salada verde com molho de azeite de oliva.
        ...
        {mostrarDieta === 'Engordar' && renderizarDieta('Dieta para Engordar', 
          ...
          Legumes cozidos, como cenoura e abobrinha.
          Salada de folhas verdes com molho de iogurte.
